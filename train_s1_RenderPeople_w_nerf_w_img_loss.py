...
from datasets.image_dataset_RenderPeople_w_nerf import ImageDataset, sample_ray
...
def load_image(img_path, smpl_model, white_bg=False, nerf_rs_scale=1.0, tgt_view=False):
...
def validate(
    ...
    tgt_img_pil, tgt_data_nerf = load_image(tgt_img_path, smpl_model, nerf_rs_scale=nerf_rs_scale, white_bg=white_bg, tgt_view=True)
...
def log_validation(
    ...
    for test_subject in test_subject_names:
        ref_img_lst_.append(test_folder + '/' + test_subject + '/camera0000/images/0000.jpg')
        guid_folder_lst_.append(test_folder + '/' + test_subject + '/camera0000')
        guid_idxes_.append(cfg.validation.guidance_indexes[0])
